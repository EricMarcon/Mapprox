...
Tous les voisins à distance inférieure à cette distance sont supprimés: l'estimation de la fonction n'est pas correcte.
...
La corrélation est très proche de 1 dès que la distance prise en compte dépasse la maille de la grille: si la valeur exacte de la fonction *M* importe peu mais que ses variations en fonction de la distance sont utiles, par exemple en tant que covariable dans un modèle, alors l'approximation n'est pas un problème.
